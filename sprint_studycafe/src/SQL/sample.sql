...
('test01'	,'1234'		, '홍길동', 'hong@test.com'		, false	,	CURRENT_TIMESTAMP),
('user02'	,'abcd'		, '김철수', 'chulsoo@test.com'	, false	,	CURRENT_TIMESTAMP),
('user03'	,'qwer'		, '이영희', 'younghee@test.com'	, false	,	CURRENT_TIMESTAMP),
('dev99'	,'devpass'	, '박개발', 'dev@test.com'		, false	,	CURRENT_TIMESTAMP);
