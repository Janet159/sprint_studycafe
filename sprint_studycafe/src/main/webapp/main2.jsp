    ...
    <main>
	    <div class="main-1920 d-flex flex-column align-items-center w-100">
		    <div class="container-1360">
                ...
                <div class="pb-6">
                    <h1 class="text-center fs-50 text-cyan-700 fw-bold mb-2">내부 시설</h1>
                    <p class="fz-normal text-center fs-30 text-muted mb-2">
                        스터디카페 전경
                    </p>
                <!-- 카드 디자인 레이아웃 -->
				<div class="d-flex align-items-start gap-5">
				    ...
				    <div class="d-flex flex-column gap-5">
				        <div class="card flex-grow-1">
				            <a href="#"><img src="<%= root %>/img/스프린트 메인페이지 최종.png" alt="new2" class="img-fluid"></a>
				        </div>
				        ...
				        <div class="d-flex justify-content-between align-items-center gap-5">
				            <div class="card flex-grow-1 text-center">
				                <a href="#" class="d-flex flex-column justify-content-center align-items-center gap-3">
				                    <img src="<%= root %>/img/스프린트 메인페이지 최종.png" alt="10" class="img-fluid">
				                    <p class="mb-0">하츄핑</p>
				                </a>
				            </div>
				            <div class="card flex-grow-1 text-center">
				                <a href="#" class="d-flex flex-column justify-content-center align-items-center gap-3">
				                    <img src="<%= root %>/img/스프린트 메인페이지 최종.png" alt="20" class="img-fluid">
				                    <p class="mb-0">하츄핑</p>
				                </a>
				            </div>
				        </div>
				    ...
				    <div class="d-flex flex-column gap-5">
				        <div class="card flex-grow-1">
				            <a href="#"><img src="<%= root %>/img/스프린트 메인페이지 최종.png" alt="new3" class="img-fluid"></a>
				        </div>
				
				        <div class="d-flex justify-content-between align-items-center gap-5">
				            <div class="card flex-grow-1 text-center">
				                <a href="#" class="d-flex flex-column justify-content-center align-items-center gap-3">
				                    <img src="<%= root %>/img/스프린트 메인페이지 최종.png" alt="30" class="img-fluid">
				                    <p class="mb-0">하츄핑</p>
				                </a>
				            </div>
				            <div class="card flex-grow-1 text-center">
				                <a href="#" class="d-flex flex-column justify-content-center align-items-center gap-3">
				                    <img src="<%= root %>/img/스프린트 메인페이지 최종.png" alt="40" class="img-fluid">
				                    <p class="mb-0">하츄핑</p>
				                </a>
				            </div>
				        </div>
