 ...
 <div class="container">
    ...
    <div class="content-box" style="height: 1050px;">
		...
		<div class="row mb-3 border-bottom border-top">
			...
			%>
				<div class="form-check">
					<input class="form-check-input" type="radio" name="category" id="opt<%= i %>" <%= check %> disabled>
        ...
        <div class="row mb-3 pb-5 border-bottom">
	        ...
	        <div class="col-sm-10">
	        <textarea class="form-control " id="floatingTextarea2" style="resize: none; height: 300px;" readonly>${result.content}</textarea>
	        </div>
        </div>
